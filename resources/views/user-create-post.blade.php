    ...
    <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md-8">
            ...
            <form method="post" action="{{route('shop-store-items')}}" enctype="multipart/form-data">
                          @csrf
                          ...
                          <div class="input-group mb-3">
                            <div class="input-group-prepend" style="width: 150px">
                              <label class="input-group-text" style="width: 150px" for="category">Kategoria</label>
                            </div>
                          ...
                          <div class="form-group">
                                  <div class="input-group mb-3">
                                      <div class="input-group-prepend" style="width: 150px">
                                           <span class="input-group-text" style="width: 150px" id="post_image_span">Dodaj zdjęcie</span>
                                       </div>
