    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-4">
                ...
                <p class="lead">
                    <strong>Data dołączenia:</strong> {{$user->created_at}}
                </p>
                <p class="lead">
                    Ostatnia zmiana: {{$user->updated_at->diffForHumans()}}
                </p>
            </div>
            <div class="col-md-8">
                ...
                <form
                    method="post"
                    action="{{ route('update.profile', $user) }}"
                ...
                >
                    ...
                    <script>
                        ...
                        function showFileName(event) {
                            ...
                            infoArea.textContent =
                                "Wybrany plik: " +
                                fileName +
                                " zostanie przycięty do rozdzielczości 300x300 px.";
                        }
                    </script>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input
                            type="url"
                            placeholder="Podaj swój adres URL"
                            class="form-control"
                            value="{{$user->url}}"
                            name="url"
                            id="url"
                ...
                <form
                    method="post"
                    action="{{ route('user-change-password', $user) }}"
                    enctype="multipart/form-data"
                >
                    @csrf @method('PUT')
                    <div class="form-group">
                        <label for="password"
                            >Nowe hasło • Minimalnie 8 znaków</label
                        >
                        <input
                            type="password"
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                Wraz z twoim kontem zostaną usunięte wszystkie
                                oferty i ogłoszenia
                                <p class="text-danger mb-0">
                                    <u>Tej czynności nie można cofnąć.</u>
                                </p>
                            </div>
                            <div class="modal-footer">
                                ...
                                <form
                                    method="post"
                                    action="{{
                                        route('user-destroy-profile', $user)
                                    }}"
                                    enctype="multipart/form-data"
                                >
                                    @csrf @method('delete')
