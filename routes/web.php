...
Route::middleware('auth')->group(function()
    {
        ...
        Route::put('/uzytkownik/{user}/update/changepassword', 'UserController@changePassword')->name('user-change-password');
        //metody PATCH
        Route::put('/shopitem/{shopItem}/update', 'ShopController@update')->name('item-update');
        //metody DELETE
        Route::delete('/uzytkownik/{user}/update/destroy', 'UserController@destroy')->name('user-destroy-profile');
        Route::delete('shopitem/{shopItem}/destroy', 'ShopController@destroy')->name('item-destroy');
    });
